...
class SimpleNet(nn.Module):
    def __init__(
        ...
        for dim in dim_hids:
            layers.append(TimeLinear(dim_in=dim_in, dim_out=dim, num_timesteps=num_timesteps))
            dim_in = dim
        layers.append(TimeLinear(dim_in=dim_in, dim_out=dim_out, num_timesteps=num_timesteps))
        self.layers = layers
        ######################
